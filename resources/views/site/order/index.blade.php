...
{{--                        <a href="{{ route('login', [ 'languageCurrent' => $languageCurrent]) }}" class="link underlined-link">Log in</a> to check out faster.--}}
{{--                    </p>--}}
                </div>
                                ...
                                <tr class="cart-item  {{ $orderItem->slug }}" id="CartItem-{{ $id }}">
                                    ...
                                    <td class="cart-item__quantity">
                                        <div class="cart-item__quantity-wrapper">
                                            ...
                                            <cart-remove-button>
                                                <a href="{{ route('deleteItemCart', ['product_id' => $orderItem->product_id]) }}"
                                            ...
                                            <div class="card__content">
                                                <div class="card__information">
                                                    <h3 class="card__heading h5">
                                                        <a href="{{ route('product', ['post_slug' => $item->slug]) }}" class="full-unstyled-link">
