<div class="commentBox">
    ...
    <div class="commentComment">
        <div class="row">
        <div class="col-md-2">
            <img class="avatar" width="50px"
                 src="{{ $userCheck ? asset(\Illuminate\Support\Facades\Auth::user()->image) : asset('site/image/no_person.png') }}" alt="avatar">
        </div>
        <div class="col-md-8">
        ...
        <div class="item">
            <div class="parent">
                <div class="row">
                    <div class="col-md-2">
                        <div class="avatar" >
                            <img width="50px" src="{{ empty($comment['user_image']) ? asset('site/image/no_person.png') : asset($comment['user_image']) }}" alt="avatar">
                            <p>
                                 <span class="username">
                                    {{ empty($comment['user_full_name']) ? 'Ẩn danh' : $comment['user_full_name'] }}
                                </span>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-10">
                        <div class="content">
                            <p style="padding: 5px;
                               ...
                               {{ $comment['content'] }}</p>
                            <p>
                            <span class="date" style="font-size: 12px; font-style: italic">
            ...
            <div class="children">
				<div class="avatar">
                    <img src="{{ empty($child->user_image) ? asset('site/image/no_person.png') : asset($child->user_image) }}" alt="avatar">
				</div>
                <div class="content">
    ...
    function commentSubmit(e) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                {{--html += '<img class="avatar" width="50px" src="'+ obj.user_image +'" alt="avatar">';--}}
