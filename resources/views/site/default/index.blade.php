                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-6 p-xs-min">
                            <div class="services-box">
                                ...
                                <a href="{{ route('post', ['cate_slug' => 'dich-vu', 'post_slug' => $item['slug']]) }}" title="{{ isset($item['title']) ? $item['title'] : '' }}">
                                    <h3>{{ isset($item['title']) ? $item['title'] : '' }}</h3>
                                </a>
                        ...
                        <div class="col-lg-3 col-md-3 col-6">
                            <div class="evo-product-block-item">
                                ...
                                <div class="product-meta">
                                    <h3><a href="{{ route('product', ['post_slug' => $item['slug']]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="evo-item-blogs">
                                ...
                                <a class="readmore" href="{{ route('post', ['cate_slug' => 'tin-tuc', 'post_slug' => $item['slug']]) }}"
                                   title="Đọc tiếp">
                                    Đọc tiếp
                                </a>
                            </div>
