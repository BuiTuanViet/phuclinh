   ...
   @include('site.partials.slider')
      ...
      <div class="content_main div_center"  >
         <div class="gioithieu_index wow fadeInUp">
            ...
            <br />
            <a class="xemthem" href="{{ route('post', ['cate_slug' => ($languageCurrent == 'vn') ? 'tin-tuc' : 'new' , 'post_slug' => ($languageCurrent == 'vn') ? 'gioi-thieu' : 'introduce']) }}">{{ $languageSetup['xem-them'] }}</a>
         </div>
         <div class="div_video">
            <style type="text/css">
               .videoShow
                        ...
                        @foreach(\App\Entity\Post::categoryShow( $slug , 5) as $id=>$post) 
                           ...
                           <div class="box_news_i wow fadeInUp" data-wow-delay="0.8s" >
							<div class="maxImg">
                              ...
                              <a href="{{ route('post', ['cate_slug' => $slug, 'post_slug' => $post->slug]) }}" >
                           ...
                           <p class="list_ttt"><a href="{{ route('post', ['cate_slug' => $slug, 'post_slug' => $post->slug]) }}">• {{ isset($post['title']) ? $post['title'] : ''  }}</a></p>
						   </div>
                           @endif
                  ...
                  <div id="ctsdiv3" style="height:auto;max-height:800px; overflow:hidden;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" id="ctstbl3" style="position:relative; margin:0px">
                        ...
                        <tr>
                           <td valign="top">
                              <div class="box_news_i wow fadeInUp" data-wow-delay="0.8s" >
                                 <a href="{{ route('post', ['cate_slug' => $slug, 'post_slug' => $post->slug]) }}" ><img src="{{ isset($post['image']) ? $post['image'] : '' }}"  alt=" {{ isset($post['title']) ? $post['title'] : ''  }}" class="img" /></a>
                                 <h2 class="title"> <a href="{{ route('post', ['cate_slug' => $slug, 'post_slug' => $post->slug]) }}">  {{ isset($post['title']) ? $post['title'] : ''  }} </a></h2>
