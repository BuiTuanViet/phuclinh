        ...
        <div class="container padding-top-10">
            <div class="row">
                <aside class="sidebar left-content col-md-12 col-lg-3">
                    ...
                    <script src="{{ asset('site/100/302/581/themes/798703/assets/search_filter.js') }}"
                                    ...
                                    <div class="aside-content filter-group">
                                        <ul class="filter-vendor">
                                            ...
                                            <li class="filter-item filter-item--check-box filter-item--green ">
                                                <label data-filter="trung tâm giúp việc Phúc Linh"
                                                       for="filter-trung-tam-giup-viec-hong-phuc"
                                                       class="trung-tam-giup-viec-phuc-linh">
                                                    <input type="checkbox" id="filter-trung-tam-giup-viec-phuc-linh"
                                                           onchange="toggleFilter(this)" data-group="Hãng"
                                                           data-field="vendor.filter_key"
                                                           data-text="Trung Tâm giúp việc Phúc Linh"
                                                           value="(&#34;Trung Tâm giúp việc Phúc Linh&#34;)"
                                                           data-operator="OR">
                                                    <i class="fa"></i>
                                                    Trung Tâm giúp việc Phúc Linh
                                                </label>
                                            </li>
                            ...
                            @foreach($products as $item)
                                <div class="col-6 col-sm-4 col-lg-4">
                                    <div class="evo-product-block-item">
                                        <div class="image">
                                            <a class="primary_img"
                                               href="{{ route('product', ['post_slug' => $item['slug']]) }}"
                                        ...
                                        <div class="product-meta">
                                            <h3>
                                                <a href="{{ route('product', ['post_slug' => $item['slug']]) }}"
                                                   title="{{ isset($item['title']) ? $item['title'] : '' }}">
