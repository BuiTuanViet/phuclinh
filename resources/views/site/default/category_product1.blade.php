...
<div id="main">
    ...
    <div class="content_main" style="text-align:center" >
        ...
        <div class="item_sp wow fadeInUp" data-wow-delay="200ms" >
            <a class="dv_img" href="{{ route('product', ['post_slug' => $product->slug]) }}">
            ...
            <h2 class="tensp"><a href="{{ route('product', ['post_slug' => $product->slug]) }}">{{ isset($product['title']) ? $product['title'] : '' }}</a>
