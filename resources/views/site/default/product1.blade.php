...
<div class="content_main" style="text-align:center;">
    ...
    <div class="item_sp wow fadeInUp" data-wow-delay="100ms" >
        <a class="dv_img" href="{{ route('product', ['post_slug' => $productRelative->slug]) }}" >
        ...
        <h2 class="tensp"><a href="{{ route('product', ['post_slug' => $productRelative->slug]) }}">{{ isset($productRelative['title']) ? $productRelative['title'] : '' }}</a>
        </h2>
