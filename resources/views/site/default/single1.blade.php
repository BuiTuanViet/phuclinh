...
<div id="main">
  ...
  <div class="tt_col_right">
    ...
    <ul>
      ...
      <li class="box_news2">
       <h2 class="news_title"> <a href="{{ route('post', ['cate_slug' => $slugPost, 'post_slug' => $postNew->slug]) }}">{{ isset($postNew['title']) ? $postNew['title'] : ''  }}</a></h2>
   ...
   <ul>
    ...
    <li class="box_news2">
     <h2 class="news_title"> <a href="{{ route('post', ['cate_slug' => $category->slug, 'post_slug' => $postRelative->slug]) }}">{{ isset($postRelative['title']) ? $postRelative['title'] : ''  }}</a></h2>
     <div class="news_mota"></div>
   </li>
   @endforeach
