...
//            $sumRating = $product->countPositive;
            $post = $this->getPostDetail($product->post_id);
            ...
            if ($product->template == 'default' || empty($product->template)) {
                return view('site.default.product', compact('product', 'categories', 'productSeen', 'point_price','point_deal'));
            } else {
                return view('site.template.'.$product->template, compact('product', 'categories', 'productSeen', 'point_price','point_deal'));
            }
        } catch (\Exception $e) {
